        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              Empowering ServiceNow professionals to achieve their career goals
              through expert guidance and proven strategies.
            </p>
            <div className="flex space-x-4">
              ...
              <button className="w-10 h-10 bg-blue-700 rounded-full flex items-center justify-center hover:bg-blue-800 transition-colors cursor-pointer">
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
