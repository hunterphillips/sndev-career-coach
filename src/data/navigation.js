  ...
  styling: {
    sections: {
      hero: {
        ...
        text: "text-white",
        button: "text-white hover:text-blue-300 border-white hover:border-blue-300",
      },
      testimonials: {
        nav: "bg-gray-50/95 backdrop-blur-sm border-b border-gray-200/50 text-gray-900",
        text: "text-gray-900",
        button: "text-gray-900 hover:text-blue-600 border-gray-300 hover:border-blue-600",
      },
      default: {
